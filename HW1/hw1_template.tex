...
% =====================================================================
\section*{Part 0 — VM setup}

Paste the complete output of the verification command from Part 0.3 here.
...
\[
  ...
  \Project{\Rel{title}}{\Select{\Rel{duration\_sec} < 999}{\Rel{track}}}
\]
...
\[
  % your expression here.  You will need \Rename twice; a product of a relation
  % with itself looks like:   \Rename{x}{\Rel{track}} \Cross \Rename{y}{\Rel{track}}
\]
...
\[
  ...
  %   \Group{\Rel{album\_id}}{\text{sum}(\Rel{duration\_sec})}{\Rel{track}}
\]
...
\textbf{(a)} In one sentence, this expression computes:
